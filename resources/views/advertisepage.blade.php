...
<body>
                    ...
                    <div class="_2kY5F">
                        <div class="_1AsHn _2siHy _38NUf">
                            <div class="_3Bswj">
                                ...
                                <form id="new_button_subcategory" method="POST" action="{{route('detail_category')}}">
                                    <div class="LzDnW">
                                        <div class="_3lCVd">
            ...
            <div class="_14s_w" id="category_description" style="display:none">
                <div class="_1AsHn _2siHy _38NUf _3aduF">
                    <div class="_3Bswj">
                        ...
                        <form id="description_form" method="POST" action="{{route('detail_description')}}">
                            <div class="_3KRvg">
            ...
            <div class="_14s_w" id="category_price" style="display:none">
                <div class="_1AsHn _2siHy _38NUf _3aduF">
                    <div class="_3Bswj">
                        ...
                        <form id="price_form" method="POST" action="{{route('detail_price')}}">
                            <div class="_3KRvg">
                                <div class="zfCs0">
            ...
            <div class="_14s_w" id="category_photo" style="opacity:0.2">
                <div class="_1AsHn _2siHy">
                    ...
                    <div class="_3Bswj">
                        ...
                        <!-- <form method="POST" id="upload_form" action="{{route('imageupload')}}"
                        ...
                        <div class="BB7X4">
                            <div class="_39Nsm">
                                ...
                                <div>
                                    ...
                                    <button class="_2sNbI _1xIyN _2xk2l _3FcC9" type="submit" id="forwardbutton">Continuer</button>
                                </div>
                            </div>
                            <!-- </form> -->
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('._11wrr').on('click', 'span[name=close]', function(){
                var image = $(this).data('image');
                console.log(image);

                var full_images = document.getElementsByClassName('full_image');
                var delete_image = full_images[full_images.length - 1];
                var html = '<div class="_11wrr"><div class="_2hSIh _26o9N ufciE"><div class="_35a0H empty_file"><span class="_1vK7W _3p-rd" name="cameraoutline"><svg viewBox="0 0 24 24" data-name="Calque 1" focusable="false"><path d="M21.6 3.54h-3.8L15.6 1.1H8.4L6.2 3.54H2.4A2.43 2.43 0 0 0 0 6v14.66a2.43 2.43 0 0 0 2.4 2.44h19.2a2.43 2.43 0 0 0 2.4-2.44V6a2.43 2.43 0 0 0-2.4-2.46zm0 17.12H2.4V6h4.86l2.2-2.45h5.08L16.74 6h4.86zM12 7.21a6.11 6.11 0 1 0 6 6.11 6.06 6.06 0 0 0-6-6.11zM12 17a3.67 3.67 0 1 1 3.6-3.67A3.65 3.65 0 0 1 12 17z"></path></svg></span><p>Photo n°2</p></div></div></div>';
                $('.l1Oku').append(html);
            ...
            $('#category_photo').on('click', '#forwardbutton', function () {
                console.log("test");
